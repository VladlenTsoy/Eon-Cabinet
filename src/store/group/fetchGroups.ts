...
export const fetchGroups = createAsyncThunk<ReturnedType, ArgProps, AppThunkProps>(
    "teacher/groups/fetch",
    async ({page = 1, categoryId}, {signal}) => {
        return await apiRequest("get", `teacher/groups/${categoryId}`, {signal, api2: true, params: {page}})
    },
    {
