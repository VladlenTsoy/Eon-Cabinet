...
const DataColumns = () => {
    ...
    return [{
        render: (text: any, record: any) =>
            <ActionColumn student={record} fetch={() => null}/>
    },
        {
            title: 'Монеты',
            dataIndex: 'coins',
        ...
        },
        {
            ...
            render: (text: any) => text ? moment(text).format('DD/MM/YYYY') : empty,
        },
        {
            title: 'Последняя активность',
            dataIndex: 'entrance_at',
            render: (text: any) => text ? momentFormatCheckYear(text, 'HH:mm DD MMM', 'HH:mm DD.MM.YY') : empty,
        },
        {
            title: 'Создан',
            dataIndex: 'created_at',
            render: (text: any) => text ? momentFormatCheckYear(text, 'DD MMM', 'DD.MM.YY') : empty,
        }];
}
