...
const Columns: ColumnsProps = () => [
    ...
    },
    {
        title: "Группа",
        render: (text, record) => (
            <Link to={`/groups/${record.student.group_id}`}>
    ...
    },
    {
        ...
        render: (text) => momentFormatCheckYear(text)
    },
    {
    ...
    },
    {
        render: (text, record) => (
            <Link
                to={`/groups/${record.student.group_id}/student/${record.student.id}/homework/${record.id}`}
            >
