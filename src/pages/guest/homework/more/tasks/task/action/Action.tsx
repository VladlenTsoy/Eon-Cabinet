...
import {changeExecutionMode, changeTotals, changeSetting} from "store/common/game/gameSplice";
...
const Action: React.FC<Action> = ({task, history, id, type}) => {
    ...
    const startApplication = (_task: any) => {
        ...
        history.push(`/guest/homework/${id}/${_task.id}/${_task.discipline_id}/${_task.task_id}`);
    };
